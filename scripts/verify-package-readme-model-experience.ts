...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-harness': { kind: 'none', reason: 'Browser-side visual skin and settings surface; registers nothing model-facing.' },
  ...
  'packages/host/mcp-inventory': { kind: 'none', reason: 'Host-side read-only Loader projection; registers nothing model-facing.' },
