...
import {
  ...
  sessionListTrashedRequestSchema,
  ...
  sessionTrashHistoryRequestSchema,
  sessionTrashRequestSchema,
...
import { skillListRequestSchema, skillReadRequestSchema, skillRemoveRequestSchema, skillWriteRequestSchema } from '../api/skills.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'session.trash': { schema: sessionTrashRequestSchema, invoke: (api, r) => api.sessions.trash(r) },
  'session.restore': { schema: sessionRestoreRequestSchema, invoke: (api, r) => api.sessions.restore(r) },
  'session.purge': { schema: sessionPurgeRequestSchema, invoke: (api, r) => api.sessions.purge(r) },
  'session.listTrashed': { schema: sessionListTrashedRequestSchema, invoke: (api, r) => api.sessions.listTrashed(r) },
  'session.trashHistory': { schema: sessionTrashHistoryRequestSchema, invoke: (api, r) => api.sessions.trashHistory(r) },
  ...
  'llm.balance': { schema: llmBalanceRequestSchema, invoke: (api, r) => api.llm.balance(r) },
}
