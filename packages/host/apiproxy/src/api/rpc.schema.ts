...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('session-trashed'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  ...
  z.object({ code: z.literal('workspace-name-invalid'), message: z.string(), details: z.object({ name: z.string() }) }),
  ...
  z.object({ code: z.literal('invalid-skill'), message: z.string(), details: z.object({ name: z.string() }) }),
