...
export interface RpcMethodMap {
  ...
  'session.trash': SessionsApi['trash']
  'session.restore': SessionsApi['restore']
  'session.purge': SessionsApi['purge']
  'session.listTrashed': SessionsApi['listTrashed']
  'session.trashHistory': SessionsApi['trashHistory']
