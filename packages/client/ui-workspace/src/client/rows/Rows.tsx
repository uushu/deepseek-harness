 ...
 * @param props.onDelete - request recoverable deletion; the owner confirms before moving the conversation to trash.
...
export function SessionNodeItem({
  ...
  /** Request recoverable deletion; the owner shows the confirmation dialog. */
  ...
  const sessionMenuItems = [
    ...
    // Deletion moves only the conversation into recoverable trash; files are never touched.
    ...onDelete === undefined
      ? []
