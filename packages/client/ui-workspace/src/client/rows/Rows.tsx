...
export function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onDelete, drag, flat = false, t }: {
  ...
  /** Delete this session permanently (row menu action; the owner confirms). */
  ...
  const sessionMenuItems = [
    ...
    // Deleting a session restores files it changed and removes its log —
    // destructive, so it is styled as danger and confirmed by the owner.
    ...onDelete === undefined
      ? []
