...
export class WorkspaceRuntime implements IWorkspaces {
  ...
  /**
   * Unarchive a session from the registry-global set. The session returns
   * to its workspace group at its original accounting slot; the projection
   * sweep and the changed frame take care of the rest.
