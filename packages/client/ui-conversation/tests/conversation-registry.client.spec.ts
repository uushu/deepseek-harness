...
function fakeSessions(ctx: Context): { sessions: ISessions; binding: SessionBinding } {
  ...
  const sessions = {
    ...
    trashSession: () => Promise.reject(new Error('unused fake Sessions operation')),
    restoreSession: () => Promise.reject(new Error('unused fake Sessions operation')),
    purgeSession: () => Promise.reject(new Error('unused fake Sessions operation')),
    listTrashed: () => Promise.reject(new Error('unused fake Sessions operation')),
    trashHistory: () => Promise.reject(new Error('unused fake Sessions operation')),
