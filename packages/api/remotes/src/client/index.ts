...
export type {
  ...
  MuxFrame, PromptContentPart, ProviderBalanceView, QuestionResponsePayload, QueueAction, RpcError, RpcId, RpcReceipt,
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, mcpInventoryRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
