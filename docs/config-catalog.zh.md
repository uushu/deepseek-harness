...
- `@deepseek-ai/dsh-client-ui-harness`（[`packages/client/ui-harness/src/index.ts`](../packages/client/ui-harness/src/index.ts)）
...
- `@deepseek-ai/dsh-host-mcp-inventory` — 需要 `loader`（[`packages/host/mcp-inventory/src/index.ts`](../packages/host/mcp-inventory/src/index.ts)）
